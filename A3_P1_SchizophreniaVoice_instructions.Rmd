...
```{r}
#Remane in data
data <- plyr::rename(data, c("dur..s." = "FullDuration","phonationtime..s."="PhonatationTime","speechrate..nsyll.dur."="Speechrate","articulation.rate..nsyll...phonationtime."="ArticulationTime","ASD..speakingtime.nsyll."="AverageSyllableDuration"))
#Make into a tibble
data <- as_tibble(data)
...
data_scale <- (c("Education","SANS","SAPS","VerbalIQ","NonVerbalIQ","TotalIQ","sd_pitch","mean_pitch","iqr_pitch","min_pitch","max_pitch","nsyll","npause","FullDuration","PhonatationTime","Speechrate","ArticulationTime","AverageSyllableDuration", "PauseDuration"))
...
# pitch variability 
pitch_variability_model1 <- lmer(iqr_pitch ~ 1 + Diagnosis + (1 + Diagnosis | uPairID), data = data_scaled_by_language, REML =F)
